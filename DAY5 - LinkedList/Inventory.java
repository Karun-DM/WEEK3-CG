...
public void insertFirst(String itemName, int itemId, int quantity, int 
price){ 
...
public void insertLast(String itemName, int itemId, int quantity, int 
price){ 
if(tail== null){ 
...
public void insert(String itemName, int itemId, int quantity, int 
price,int index){ 
if (index ==0){ 
insertFirst(itemName, itemId, quantity, price); 
} 
